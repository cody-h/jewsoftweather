...
public class CoolWeatherDB {
    ...
    private CoolWeatherDB(Context context) {
        CoolWeartherOpenHelper dbHelper = new CoolWeartherOpenHelper(context, DB_NAME, null, VERSION);
    ...
    public  List<City> loadCities(int provinceId){
        ...
        Cursor cursor = db.query("City", null, "province_code =  ? ", new String[]{String.valueOf(provinceId)}, null, null, null);
